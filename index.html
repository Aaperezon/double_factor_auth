...
<body>
	...
	<div class="form-structor">
			<div class="signup">
				<div class="title">
					<h1 class="form-title" id="signup">Registro</h1>
				</div>
			...
			<form id="register_form2">
				<div class="login slide-up">
					<div class="center">
						<h2 class="form-title"  id="login" ><span>or</span>Iniciar Sesión</h2>
						<div class="form-holder">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Registro: autenticación segura de dos factores</h5>
      ...
      <div class="modal-body">
		<div class="container">
			...
			<div class="alignCenter">
				<div id="register_text">Tiempo restante: 5</div>
				<div id="timer_text">Leyendo gesto: 1</div>
